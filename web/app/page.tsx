  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <header className="fixed top-6 left-1/2 -translate-x-1/2 z-50">
        <nav className="flex items-center justify-between gap-120 px-8 py-3 rounded-full bg-black/40 backdrop-blur-xl border border-white/10 whitespace-nowrap">
          ...
          <div className="flex items-center gap-6 shrink-0">
            ...
            <Link
              href="/signup"
              className="group flex items-center justify-center gap-0 px-4 py-2 bg-white text-black text-sm font-medium rounded-full hover:bg-white/90 hover:scale-105 transition-[transform,background-color] duration-200"
            >
              Start Free
              <ArrowRight className="h-4 w-0 opacity-0 group-hover:w-4 group-hover:opacity-100 group-hover:ml-1 transition-[width,opacity,margin] duration-200" />
            </Link>
          </div>
        </nav>
      </header>
      ...
      <footer className="border-t border-border/40 bg-muted/10">
        <div className="container mx-auto px-12 md:px-24 lg:px-32 py-12">
          ...
          <div className="mt-12 pt-8 border-t border-border text-sm text-muted-foreground mb-8 text-center">
            Made with ❤️ by{" "}
            <Link
              href="https://github.com/JagjeevanAK"
              target="_blank"
